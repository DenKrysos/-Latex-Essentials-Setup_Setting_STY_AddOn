...
%================================================
% USAGE: \begin{itemize}[\labpraegA]   or   \item[\labpraegAsym]
%   (Standing for: Label-Prägnanz-#
%   (The \labpraeg# are defined to be readily used for a whole itemization environment (i.e. comprise also a fitting left-margin)
%   (The \labpraeg#sym can be used for single items as they do only define the Symbol itself
\newcommand{\labpragAsym}{\textbf{$\scriptstyle\rightarrow$}}%
\SetEnumitemKey{labpragA}{label=\labpragAsym,leftmargin=1.25em}%
\newcommand{\labpragBsym}{\textbf{$\scriptstyle\Rightarrow$}}%
\SetEnumitemKey{labpragB}{label=\labpragBsym,leftmargin=1.25em}%
\newcommand{\labpragCsym}{$\scriptstyle\pointright$}%
\SetEnumitemKey{labpragC}{label=\labpragCsym,leftmargin=1.4em}%
\newcommand{\labpragDsym}{$\scriptstyle\blacktriangleright$}%
\SetEnumitemKey{labpragD}{label=\labpragDsym,leftmargin=1.25em}%
\newcommand{\labpragEsym}{$\scriptstyle\compoundarrow$}%
\SetEnumitemKey{labpragE}{label=\labpragEsym,leftmargin=1.4em}%
%=================================
% Label-Presets END
%================================================
%
...
\newcommand{\mydash}{\foreignlanguage{ngerman}{"=}}
%
...
\ifthenelse{\tikzAimedHeight<\tikzheight}{%
	...
	\ifthenelse{\tikzAimedWidth<\tikzwidth}{%
		...
		\expandafter\efigure\expandafter[\tikzFloatPositioning]%
			\centering%
% 	 		\fbox{%
			\includestandalone[width=\tikzwidth,angle=#8,mode=#1]{#3/#2}%
% 	 		}%
			\IfValueTF{#5}{%
				\caption[#5]{#4}%
			}{%
