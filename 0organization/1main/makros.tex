...
%================================================
\newcommand{\labItDefaultA}{\textbullet}%
\newcommand{\labItDefaultB}{\textbf{--}}%
\newcommand{\labItDefaultC}{\ast}%
\newcommand{\labItDefaultD}{\textperiodcentered}%
%
...
\SetEnumitemKey{labDKDot}{label=\labDKsymDot,leftmargin=0.9em}%
\SetEnumitemKey{labDKAst}{label=\labDKsymAst,leftmargin=1.0em}%
\SetEnumitemKey{labDKPointright}{label=\labDKsymPointright,leftmargin=1.3em}%
\SetEnumitemKey{labDKTriangle}{label=\labDKsymTriangle,leftmargin=1.0em}%
\SetEnumitemKey{labDKTriangleBl}{label=\labDKsymTriangleBl,leftmargin=1.05em}%
\SetEnumitemKey{labDKLozenge}{label=\labDKsymLozenge,leftmargin=1.0em}%
\SetEnumitemKey{labDKLozengeBl}{label=\labDKsymLozengeBl,leftmargin=1.0em}%
\SetEnumitemKey{labDKSquare}{label=\labDKsymSquare,leftmargin=1.0em}%
\SetEnumitemKey{labDKSquareBl}{label=\labDKsymSquareBl,leftmargin=1.0em}%
\SetEnumitemKey{labDKDiamondSplit}{label=\labDKsymDiamondSplit,leftmargin=1.1em}%
\SetEnumitemKey{labDKCrossA}{label=\labDKsymCrossA,leftmargin=1.1em}%
\SetEnumitemKey{labDKCrossB}{label=\labDKsymCrossB,leftmargin=1.1em}%
\SetEnumitemKey{labDKCrossC}{label=\labDKsymCrossC,leftmargin=1.1em}%
\SetEnumitemKey{labDKCrossD}{label=\labDKsymCrossD,leftmargin=1.1em}%
\SetEnumitemKey{labDKCrossE}{label=\labDKsymCrossE,leftmargin=1.1em}%
%=================================
% Label Symbols END
%================================================
%
