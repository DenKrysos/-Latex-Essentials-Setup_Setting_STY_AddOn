...
\newcommand{\gleref}[1]{Gleichung~\ref{#1}}%
\newcommand{\equref}[1]{Equation~\ref{#1}}%
% - - - - - - - - - - - - - - - -
% To do it *automatically*, using "Cleverref"
\newcommand{\entityref}[1]{\cref{#1}}%
...
\makeatother%
\newcommand{\entitynamref}[1]{\numnamref{#1}}%
\newcommand{\elenamref}[1]{\numnamref{#1}}%
\newcommand{\typenamref}[1]{\numnamref{#1}}%
%
% - - - - - - - - - - - - - - - -
% - Legacy stuff
...
%     - Defining a nice Macro for use instead, doesn't really makes things easier, as then, this macro does not properly expand
%   -> So, for making this process easier: Use the following Macro as opposed hacking something yourself.
%   -> Hence, here you have a "Boilerplate". Use the following, instead of a simple \gls[...]{} (adjust 'text', 'desc', 'plural', etc. as required)
%================================================
% \texorpdfstring{\glstext{#2}}{\glsentrytext{#2}}
\makeatletter%
\newcommand{\glstextHead}[1]{%
    \expandafter\texorpdfstring{\expandafter\glstext{#1}}{\expandafter\glsentrytext{#1}}%
}%
\newcommand{\glsdescHead}[1]{%
    \expandafter\texorpdfstring{\expandafter\glsdesc{#1}}{\expandafter\glsentrydesc{#1}}%
}%
\newcommand{\glstextplHead}[1]{%
    \expandafter\texorpdfstring{\expandafter\glsplural{#1}}{\expandafter\glsentryplural{#1}}%
}%
\newcommand{\glsdescplHead}[1]{%
    \expandafter\texorpdfstring{\expandafter\glsdescplural{#1}}{\expandafter\glsentrydescplural{#1}}%
}%
\makeatother%
%
%
