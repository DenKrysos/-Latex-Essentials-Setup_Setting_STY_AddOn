...
%  I've redefined the normal \chapter-Cmd to be way more powerful and by that, this also includes the here provided Functionality. Look into "0organization/1main/2includes/packages/typografie_cmd.tex"
%------------------------------------------------------------------------
