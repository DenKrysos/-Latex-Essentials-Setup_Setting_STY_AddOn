...
\ifdef{\DenKrLayoutLanguage}{%
    \expandafter\ifstrequal\expandafter{\DenKrLayoutLanguage}{english}{%
        \def\DenKrGlossaryRefLabel{Glossaries}%
        \def\DenKrAcronymRefLabel{Acronyms}%
        \def\DenKrRefLabelAKA{Also known as}%
        \def\DenKrGlsPrintOtherLang#1{%
            \DenKrGlsPrintOtherLangFormat{#1}{Zu Deutsch}{textDE}{longDE}{\glsentrylongDE{#1}}{\glsentrytextDE{#1}}%
       }%
    }{%
    \expandafter\ifstrequal\expandafter{\DenKrLayoutLanguage}{ngerman}{%
        \def\DenKrGlossaryRefLabel{Glossar}%
        \def\DenKrAcronymRefLabel{Acronyme}%
        \def\DenKrRefLabelAKA{Auch genannt}%
        \def\DenKrGlsPrintOtherLang#1{%
            \DenKrGlsPrintOtherLangFormat{#1}{In English}{textEN}{longEN}{\glsentrylongEN{#1}}{\glsentrytextEN{#1}}%
        }%
    }{%
...
{% based on list style (adapt as required)
    ...
    \renewcommand{\glossentry}[2]{%
        ...
        \ifglshasfield{crossRef}{##1}{%
            \space|\space%
            \textit{\DenKrGlossaryRefLabel}: \glstext{\glsentrycrossRef{##1}}%
        }{}%
    }%
}%
...
%
        ...
        \ifglshasfield{crossRef}{##1}{%
            .\space%
            \textit{\DenKrAcronymRefLabel}: \glstext{\glsentrycrossRef{##1}}%
        }{}%
        \ifglshasfield{url}{##1}{\glspar
    		\url{\glsentryurl{##1}}}{}%
    	}%
