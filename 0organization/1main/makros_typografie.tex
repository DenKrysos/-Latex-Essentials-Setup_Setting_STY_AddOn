...
%vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
%____________________________________________________________________
% Normalized Macros for the ones below (i.e. that don't take a maximum value as argument, but normalize to an intrinsic one)
\def\rateTasteMax{10}%
\newcommand{\rateTaste}[1]{%
    \ifnumcomp{\rateTasteMax}{<}{#1}{%
        \def\rateTasteVal{\rateTasteMax}%
    }{%
        \def\rateTasteVal{#1}%
    }%
    \rating{\rateTasteVal}{\rateTasteMax}%
}%
\def\rateTimeMax{6}%
\newcommand{\rateTime}[1]{%
    \ifnumcomp{\rateTimeMax}{<}{#1}{%
        \def\rateTimeVal{\rateTimeMax}%
    }{%
        \def\rateTimeVal{#1}%
    }%
    \timerating{\rateTimeVal}{\rateTimeMax}%
}%
\def\rateHealthMax{5}%
\newcommand{\rateHealth}[1]{%
    \ifnumcomp{\rateHealthMax}{<}{#1}{%
        \def\rateHealthVal{\rateHealthMax}%
    }{%
        \def\rateHealthVal{#1}%
    }%
    \quant{\rateHealthVal}{\rateHealthMax}%
}%
%------------------------------------------------
\newcommand\rating[2]{%
