...
\newcommand{\orcidIco}[1]{\href{https://orcid.org/#1}{\includesvg[height=1.5ex]{./8graphics/orcid.logo.icon}}}%
\newcommand{\orcidIcoText}[1]{\href{https://orcid.org/#1}{\includegraphics[height=1.5ex]{./8graphics/orcid.logo.icon.eps} \hspace{1.5em} orcid.org/#1}}%
%
%####################################################################
%====================================================================
